...
////-------------------------------------------------------------------------
//void tModConv::StartServer(const QString &_addr, const int _port)
//{
...
//}
////-------------------------------------------------------------------------
//void tModConv::SendFile(const QString &_file_name)
//{
//    db_op->PrepareSendFile(_file_name);

//}
////-------------------------------------------------------------------------
//void tModConv::DeletingServerFile(const QString &_file_name)
//{
//    db_op->PrepareDeletingServer(_file_name);
//}
////-------------------------------------------------------------------------
//void tModConv::CancelOperations()
//{
//    conv->CancelOperations();
//}
////-------------------------------------------------------------------------
//void tModConv::EndConveyor()
//{
...
//}
////-------------------------------------------------------------------------
//void tModConv::OnDisconnect()
//{
//    emit Disconnecting();
//}
////-------------------------------------------------------------------------
//void tModConv::OnAutorizStart()
//{
//    emit AutorizStart();
//}
////-------------------------------------------------------------------------
//void tModConv::ErrorConveyor()
//{
//    qDebug() << QString::fromUtf8("Выполнение пакета команд прервано");
//    l="tModConv \tErrorConveyor\tВыполнение пакета команд прервано";
//    log.Write(l);

//    EndConveyor();
//}
////-------------------------------------------------------------------------
//void tModConv::Autorization(const QString& _login, const QString& _password)
//{
//    l="tModConv \tAutorization\tОтправка команды авторизации";
//    log.Write(l);
...
//}
////-------------------------------------------------------------------------
//void tModConv::OnListFiles()
//{
//    l="tModConv \t OnListFiles \t Отправка команды запроса списка файлов из конвейера моделей";
//    log.Write(l);
...
//}
////-------------------------------------------------------------------------
//void tModConv::ReceiveFile(const QString& _file_name)
//{
//    db_op->PrepareReceiveFile(_file_name);
//}
////-------------------------------------------------------------------------
//void tModConv::DeletingLocalFile(const QString& _file_name)
//{
//    db_op->PrepareDeletingLocal(_file_name);
//}
////-------------------------------------------------------------------------
//void tModConv::StartSendDeleteFiles(const int _max_model)
//{
//    l="tModConv \tStartSendDeleteFiles\tФормирование списка команд транзакции передачи и удаления файлов на сервере";
//    log.Write(l);
...
//            l="tModConv \tStartSendDeleteFiles\tЛокальный файл изменился. Выполнение списка отменено";
//            log.Write(l);
...
//    else
//    {
//        l="tModConv \tStartSendDeleteFiles\tВсе модели отправлены";
//        log.Write(l);
...
//        l="tModConv \tStartSendDeleteFiles\t НАЧАЛО ПРОЦЕДУРЫ ОБНОВЛЕНИЯ LAST";
//        log.Write(l);
...
//}
////-------------------------------------------------------------------------
//void tModConv::MarkLastTables(const bool _send, const QString& _user_login)
//{
...
////-------------------------------------------------------------------------
//void tModConv::StartReceiveDeleteFiles(const QString &_root, int _custom_copy, int _max_model)
//{
//    mod_custom_copy=_custom_copy;
//    l="tModConv \tStartReceiveDeleteFiles\tФормирование списка команд транзакции приема и удаления файлов на клиенте";
//    log.Write(l);
//    root_folder=_root;
...
//            l="tModConv \tStartReceiveDeleteFiles\tЛокальный файл изменился. Выполнение списка отменено";
//            log.Write(l);
...
//    else
//    {
//        l="tModConv \tStartReceiveDeleteFiles\tВсе модели приняты";
//        log.Write(l);
...
//}
////-------------------------------------------------------------------------
//void tModConv::CorrectLastSynch(const bool _server)
//{
//    conv->CorrectLastSynch(all_files, _server);
//    all_files.clear();
//}
////-------------------------------------------------------------------------
//void tModConv::SetTransactionFlag(const bool _flag)
//{
//    Transaction=_flag;
//}
////-------------------------------------------------------------------------
//void tModConv::OnEndTransactions()
//{
//    db_op->RefreshModelsFiles();
//    emit EndTransactionsMain();
//}
////-------------------------------------------------------------------------
//void tModConv::SendLoginPassword(const QString &_login, const QString &_password, const int _row, const bool _new_user)
//{
//    l="tModConv \tSendLoginPassword\tПроверка и регистрация пользователя на сервере";
//    log.Write(l);
...
//}
////-------------------------------------------------------------------------
//void tModConv::SendDeleteLogin(const int _row)
//{
//    l="tModConv \tSendDeleteLogin\t Удаление пользователя с сервера";
//    log.Write(l);
...
//}
////-------------------------------------------------------------------------
//void tModConv::ReceiveLoginsTable()
//{
//    l="tModConv \tReceiveLoginsTable\t Запрос таблицы логинов";
//    log.Write(l);
...
//}
////-------------------------------------------------------------------------
//void tModConv::SavePermissionsToServer(const qlonglong _num_login)
//{
//    l="tModConv \tSavePermissionsToServer\t Запись на сервер таблицы разрешений";
//    log.Write(l);
...
//}
////-------------------------------------------------------------------------
//void tModConv::SetLogin(const QString& _user_login)
//{
//    user_login=_user_login;
//    conv->SetLogin(_user_login);
//}
////-------------------------------------------------------------------------
//void tModConv::ClearAllList()
//{
//    all_files.clear();

//}
////-------------------------------------------------------------------------
//void tModConv::SaveLoginWritable(const QStandardItemModel* _model, const int _row)
//{
//    bool check=false;
//    db_op->SaveLoginsWritable(_model, _row, check);
//    l="tModConv \tSaveLoginWritable\tЗапись разрешения на запись на сервере";
//    log.Write(l);
