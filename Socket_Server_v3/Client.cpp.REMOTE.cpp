...
//    Preset->C2.Root="D:/Proba/";
    ...
    connect(this, SIGNAL(DisconnectClient(int)), parent, SLOT(slOnDisconnectClient(int)));
    connect(this, SIGNAL(ReceiveFile(int,QString,int)), parent, SLOT(OnReceiveFile(int,QString,int)));
